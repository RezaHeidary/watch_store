      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            MyTextField(
                lable: Strings.otpCodeSendFor
                    .replaceAll(Strings.replace, "09125555555"),
                hint: Strings.enterVerificationCode,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: ()=> Navigator.pushReplacementNamed(context, Screens.registerUser),
                  child: const Text(
                    Strings.sendOtpCode,
